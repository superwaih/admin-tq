...
const actions: Action[] = [
  { title: 'Improve your AIF',  sub: 'AI-powered suggestions',   icon: <Sparkles size={15} />, iconBg: 'bg-purple-50 dark:bg-purple-500/15 text-purple-600 dark:text-purple-400', href: '/student/essay' },
  { title: 'Practice MMI',      sub: 'Real-world interview prep', icon: <Mic size={15} />,      iconBg: 'bg-blue-50   dark:bg-blue-500/15   text-blue-600   dark:text-blue-400',   href: '/student/mmi' },
  { title: 'Check your odds',   sub: 'Run admission simulator',   icon: <BarChart3 size={15} />,iconBg: 'bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400', href: '/student/simulator' },
  { title: 'Update grades',     sub: 'Keep your profile strong',  icon: <BookOpen size={15} />, iconBg: 'bg-amber-50  dark:bg-amber-500/15  text-amber-600  dark:text-amber-400',  href: '/student/grades' },
];
