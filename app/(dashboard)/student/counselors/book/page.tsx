...
const COUNSELORS_DATA: Record<string, {
  ...
  '1': { name: 'Dr. Sarah Chen',    title: 'Senior Admissions Counselor', university: 'University of Toronto',  experience: '12+', rating: 4.9, reviews: 127, students: 340, successRate: 94, avatar: 'SC', gradient: 'from-blue-500 to-indigo-600',    verified: true,  specialties: ['Engineering', 'AIF Expert', 'Essay Writing'], price: 120 },
  '2': { name: 'Marcus Williams',   title: 'Health Sciences & Medical Coach', university: 'University of British Columbia', experience: '8+', rating: 4.8, reviews: 89, students: 215, successRate: 91, avatar: 'MW', gradient: 'from-emerald-500 to-teal-600', verified: true,  specialties: ['Medical', 'MMI Prep', 'CASPer Coaching'],    price: 95 },
  '3': { name: 'Aisha Patel',       title: 'Business & Commerce Admissions Expert', university: 'Ivey Business School', experience: '10+', rating: 4.9, reviews: 103, students: 278, successRate: 92, avatar: 'AP', gradient: 'from-violet-500 to-purple-600', verified: true,  specialties: ['Business', 'Commerce', 'Interview Prep'],    price: 110 },
  '4': { name: 'Étienne Tremblay',  title: 'Arts, Humanities & Law Advisor',      university: 'McGill University',          experience: '7+',  rating: 4.7, reviews: 64,  students: 142, successRate: 88, avatar: 'ÉT', gradient: 'from-rose-500 to-pink-600',     verified: true,  specialties: ['Arts', 'Law', 'Personal Statements'],        price: 80 },
  '5': { name: 'Dr. Priya Nair',    title: 'CS, AI & Data Science Admissions Mentor', university: 'University of Waterloo',  experience: '9+',  rating: 4.8, reviews: 76,  students: 189, successRate: 90, avatar: 'PN', gradient: 'from-cyan-500 to-blue-600',    verified: true,  specialties: ['Computer Science', 'AI & ML', 'Portfolio Review'], price: 130 },
  '6': { name: 'James Okoye',       title: 'OUAC & Application Strategy Specialist', university: 'University of Calgary',    experience: '6+',  rating: 4.6, reviews: 51,  students: 123, successRate: 87, avatar: 'JO', gradient: 'from-amber-500 to-orange-600', verified: true,  specialties: ['OUAC Strategy', 'Program Selection'],         price: 75 },
};

const DEFAULT_COUNSELOR = COUNSELORS_DATA['1'];

const CONSULT_TYPES = [
  { key: 'essay',      label: 'Essay Review',     icon: FileText,       desc: 'Get Overall guidance for your admission journey.', dur: '60 min', price: 'CAD 120' },
  { key: 'mock',       label: 'Mock Interview',   icon: MessageSquare,  desc: 'Get Overall guidance for your admission journey.', dur: '60 min', price: 'CAD 120' },
  { key: 'general',   label: 'Consultation',     icon: Video,          desc: 'Get Overall guidance for your admission journey.', dur: '60 min', price: 'CAD 120' },
  { key: 'mmi',        label: 'MMI Prep',         icon: Mic,            desc: 'Get Overall guidance for your admission journey.', dur: '60 min', price: 'CAD 120' },
];
...
export default function BookConsultationPage() {
  ...
  const handleBook = useCallback(() => {
    ...
    router.push(`/student/counselors/book/payment?${q.toString()}`);
  }, [id, selectedType.label, dateLabel, selectedTime, counselor.price, router]);
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0f1117]">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* ── Header ── */}
        <div className="mb-6">
          <Link href="/student/counselors" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8e92ad] hover:text-blue-600 transition-colors mb-2">
          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-3 pb-8">
              ...
              <button onClick={handleBook}
                ...
                <Calendar size={14}/> Continue to Payment
              </button>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-[#161a27] rounded-2xl border border-gray-100 dark:border-white/6 shadow-sm p-5">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label:'Fee',               value: `CAD ${counselor.price}`, highlight: true },
              ...
              <div className="mt-4 pt-4 border-t border-gray-50 dark:border-white/5 flex items-center justify-between">
                ...
                <span className="text-sm font-black text-blue-600 dark:text-blue-400">CAD {counselor.price}</span>
              </div>
            </div>
