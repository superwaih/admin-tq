  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0f1117]">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-0">
        ...
        {/* ── Header ── */}
        <div className="mb-6">
          <Link href="/student/strategy" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8e92ad] hover:text-blue-600 transition-colors mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {!(step === 5 && done) && (
              <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3 pb-8">
                ...
                <div className="flex items-center gap-2">
                  <Link href="/student/strategy" className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-all">
