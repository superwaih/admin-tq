...
import { Hammer, ArrowRight, X } from 'lucide-react';
    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-50 via-blue-100/60 to-blue-50 dark:from-blue-950/50 dark:via-blue-900/30 dark:to-blue-950/50 border border-blue-200/80 dark:border-blue-500/25">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center gap-4 p-5">
        <div className="flex items-start sm:items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 leading-snug">
              <span className="text-blue-700 dark:text-blue-300 font-bold">Next milestone: secure an employer sponsor</span>
              {' — '}you&apos;re 1 step away from registering your apprenticeship.
            </p>
            <div className="flex items-center gap-2.5 mt-2.5">
              <div className="flex-1 h-1.5 bg-blue-100 dark:bg-blue-500/20 rounded-full overflow-hidden max-w-[180px]">
                <div className="h-full bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transition-all" style={{ width: '66%' }} />
              </div>
              <span className="text-[11px] font-bold text-blue-700 dark:text-blue-300 shrink-0">2 of 3 steps</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Button
            onClick={() => router.push('/vocational-technical-student-route/milestones')}
