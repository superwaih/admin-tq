      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 self-start sm:self-auto">
            ...
            <Button asChild className="bg-blue-600 hover:bg-blue-700 rounded-xl px-5 h-10 font-semibold text-sm shadow-sm shadow-blue-200 flex gap-2">
              <Link href="/university-college-student-route/mmi/practice">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="relative flex items-center gap-3 shrink-0">
            ...
            <Button asChild className="bg-white hover:bg-blue-50 text-blue-700 font-bold rounded-xl px-5 h-10 text-sm shadow-sm flex gap-2">
              <Link href="/university-college-student-route/mmi/practice">
