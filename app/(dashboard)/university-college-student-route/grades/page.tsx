...
const SUBJECT_AREAS = [
  ...
  'Computer Science', 'Fine Arts', 'Physical Education', 'Languages', 'Other',
];
...
const COURSE_STATUSES = [
  ...
  { key: 'paused',   label: 'Behind',     desc: 'Needs improvement and attention',  icon: PauseCircle,   iconCls: 'text-violet-500',  bg: 'bg-violet-100 dark:bg-violet-500/20' },
];
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-[#161a27] rounded-2xl shadow-2xl border border-gray-100 dark:border-white/8 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 sm:px-8 pt-8 pb-6">
          ...
          <div className="mb-6 pr-20">
            ...
            <p className="text-sm text-slate-400 dark:text-[#8e92ad] mt-0.5">Add a new course to track your grades and progress.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <div className="relative">
                <input value={credit} onChange={e => setCredit(e.target.value)} placeholder="eg. 10" type="number" min="0"
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-5">
            <div>
              ...
              <input value={currentGrade} onChange={e => setCurrentGrade(e.target.value)} placeholder="eg. 92" type="number" min="0" max="100"
                className="w-full h-10 px-3 text-sm bg-white dark:bg-[#1a1f30] border border-gray-200 dark:border-white/10 rounded-xl text-slate-700 dark:text-slate-200 placeholder:text-slate-300 dark:placeholder:text-[#5a5f78] outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all"/>
            </div>
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">
              ...
              <div className="relative">
                <input value={targetGrade} onChange={e => setTargetGrade(e.target.value)} placeholder="eg. 92" type="number" min="0" max="100"
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-sm font-semibold text-white hover:bg-blue-700 shadow-sm shadow-blue-200 dark:shadow-blue-600/20 transition-all">
