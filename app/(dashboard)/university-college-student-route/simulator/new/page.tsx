    ...
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0f1117]">
      <div className="max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
          <div>
            <Link href="/university-college-student-route/simulator" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8e92ad] hover:text-blue-600 transition-colors mb-2">
          ...
          <div className="flex items-center gap-2 shrink-0 self-start">
            ...
            <Link href="/university-college-student-route/simulator"
