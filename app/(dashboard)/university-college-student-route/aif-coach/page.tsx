  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0f1117]">
      ...
      <div className="max-w-[1380px] mx-auto space-y-5">
        ...
        {/* ── Back + Header ─────────────────────────────── */}
        <div>
          <Link href="/university-college-student-route" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8e92ad] hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors mb-2">
            ...
            <div className="xl:col-span-2 space-y-5">
              ...
              <div className="bg-white dark:bg-[#161a27] rounded-2xl border border-gray-100 dark:border-white/6 shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/university-college-student-route/aif-insights" className="flex items-center gap-1 text-[11px] font-semibold text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300 transition-colors">
                ...
                <div className="space-y-1">
                  {RECOMMENDED.map((r, i) => {
                    ...
                    if (r.title === 'Top Programs for You')
                      return <Link key={i} href="/university-college-student-route/top-programs" className={cls}>{inner}</Link>;
                    if (r.title === 'Essays Feedback')
                      return <Link key={i} href="/university-college-student-route/essay" className={cls}>{inner}</Link>;
                    if (r.title === 'MMI Practice')
                      return <Link key={i} href="/university-college-student-route/mmi" className={cls}>{inner}</Link>;
                    return (
