...
export default function BookConsultationPage() {
  ...
  const handleBook = useCallback(() => {
    ...
    router.push(`/university-college-student-route/counselors/book/payment?reqId=${req.id}`);
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0f1117]">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* ── Header ── */}
        <div className="mb-6">
          <Link href="/university-college-student-route/counselors" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8e92ad] hover:text-blue-600 transition-colors mb-2">
